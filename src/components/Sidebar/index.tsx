        ...
        icon: (
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path d="M6.819 8.165h3.147v1.049h-3.147v-1.049z" fill="#ffffff">
                {" "}
              </path>{" "}
              <path d="M6.819 18.623h3.147v1.049h-3.147v-1.049z" fill="#ffffff">
                {" "}
              </path>{" "}
              <path d="M23.603 8.165h3.147v1.049h-3.147v-1.049z" fill="#ffffff">
                {" "}
              </path>{" "}
              <path
