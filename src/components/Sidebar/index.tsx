...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Invoices",
        route: "#",
        children: [{ label: "Create new invoice", route: "/invoices" }],
      },
      {
        icon: (
          <svg
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path d="M6.819 8.165h3.147v1.049h-3.147v-1.049z" fill="">
                {" "}
              </path>{" "}
              <path d="M6.819 18.623h3.147v1.049h-3.147v-1.049z" fill="">
                {" "}
              </path>{" "}
              <path d="M23.603 8.165h3.147v1.049h-3.147v-1.049z" fill="">
                {" "}
              </path>{" "}
              <path d="M23.603 18.623h3.147v1.049h-3.147v-1.049z" fill="">
                {" "}
              </path>{" "}
            </g>
          </svg>
        ...
        label: "Recovery",
        route: "#",
        children: [{ label: "Recovery Records", route: "/recovery" }],
      },
      {
        icon: (
          <svg
      ...
      },
      {
        icon: (
          ...
          >
            ...
            >
              <path
                d="M4360 4709 c-402 -20 -440 -26 -480 -76 -11 -14 -25 -43 -31 -65 -18
                -68 0 -99 148 -249 73 -74 133 -140 133 -145 0 -5 -404 -413 -897 -906 l-898
                -898 -420 420 c-462 461 -465 463 -580 464 -43 0 -73 -7 -107 -23 -33 -17
                -204 -182 -621 -600 -520 -521 -576 -581 -591 -625 -35 -107 -9 -199 81 -288
                79 -77 128 -101 207 -101 117 0 116 -1 598 481 l438 436 423 -420 c261 -260
                436 -427 459 -437 59 -27 118 -31 184 -12 l59 16 1042 1042 1042 1041 144
                -141 c118 -116 151 -143 182 -149 92 -17 182 54 199 156 3 19 15 245 27 502
                l22 466 -22 44 c-36 75 -72 88 -232 87 -74 -1 -303 -10 -509 -20z"
              />
              <path
                d="M4172 2947 l-382 -382 0 -1061 0 -1061 26 -27 27 -26 357 0 357 0 27
                26 26 27 0 1416 0 1417 -28 27 -28 27 -382 -383z"
              />
              <path
                d="M3100 1875 c-201 -201 -386 -382 -412 -403 l-48 -36 0 -492 0 -492
                26 -31 26 -31 359 0 360 0 24 24 c13 13 26 39 30 57 3 19 4 424 3 902 l-3 867
                -365 -365z"
              />
              <path
                d="M1490 1210 c0 -780 0 -783 48 -809 14 -7 140 -11 375 -11 l355 0 26
                31 26 31 -2 446 -3 447 -55 6 c-68 7 -117 23 -195 62 -48 24 -108 77 -310 278
                -138 137 -254 249 -258 249 -4 0 -7 -329 -7 -730z"
              />
              <path
                d="M905 1672 c-181 -179 -277 -268 -315 -289 -61 -33 -133 -58 -197 -68
l-43 -7 0 -433 0 -432 26 -27 27 -26 359 0 359 0 24 26 25 27 0 743 c0 409 -1
744 -2 744 -2 0 -120 -116 -263 -258z"
              />
            </g>
          </svg>
        ),
        label: "Sale",
        route: "#",
        children: [{ label: "Product Sale", route: "/sale" }],
      },
    ],
  },
  // {
