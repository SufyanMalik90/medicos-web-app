...
const SettingBoxes = () => {
 ...
 ac suscipit diam sem a felis. Cras sapien ex, blandit eu dui et suscipit gravida nunc. Sed sed est quis dui."
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    onClick={handleCencelProfileEdit}
                    className={`${edit ? "flex" : "hidden"} justify-center rounded-[7px] border border-stroke px-6 py-[7px] font-medium text-dark hover:shadow-1 dark:border-dark-3 dark:text-white`}
                    type="submit"
                  >
                    Cancel
                  </button>
