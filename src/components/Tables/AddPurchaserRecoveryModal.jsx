...
const AddPurchaserRecoveryModal = ({ledger, toggleModal, modalRef, isOpen, setIsOpen, setUpdate}) => {
  ...
  const [loading, setLoading] = useState(false); // Add loading state
    ...
    const handleKeyDown = (e, nextRef) => {
      ...
      async function handleUpdateProduct() {
        ...
        try {
          const response = await api.post("/api/add-purchaser-payment", {
            purchaser_id: ledger.purchaser_id,
  ...
  >
    ...
    >
      ...
      />
      {!isAmountValid ? <p className='text-red-600 font-bold'>Invalid pain amount</p> : null}
      <button
...
export default AddPurchaserRecoveryModal